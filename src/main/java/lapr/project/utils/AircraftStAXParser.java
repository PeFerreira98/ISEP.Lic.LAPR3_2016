...
//                            d_TSFC = Double.parseDouble(characters.getData().replace(" SI", ""));
                        ...
                        if (b_Cdrag0) {
                            ...
                            d_Cdrag0 = Double.parseDouble(characters.getData());
                            b_Cdrag0 = false;
                        }
                    ...
                    case XMLStreamConstants.END_ELEMENT:
                        ...
                        if (endName.equalsIgnoreCase("aircraft")) {
                            this.c_aircraftModel = new AircraftModel(s_airId, s_airDescription, s_maker, AircraftModel.Type.valueOf(s_type.toUpperCase()), d_numberMotors, s_motor, AircraftModel.MotorType.valueOf(s_motorType.toUpperCase()), d_cruiseAltitude, d_cruiseSpeed, d_TSFC, d_lapseRateFactor, d_thrust0, d_thrustMaxSpeed, d_maxSpeed, d_EWeight, d_MTOW, d_maxPayload, d_fuelCapacity, d_VMO, d_MMO, d_wingArea, d_wingSpan, d_aspectRatio, d_e, c_cDragRegister);
